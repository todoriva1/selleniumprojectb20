...
PIQ:
    ...
    -> endsWith
    -> contains
    -> I could find a static parent or child to locate my web element. If I don't have any one those, I can use one of the 3 methods that comes from xpath: contains, startswith and ends with.
=========================================================================

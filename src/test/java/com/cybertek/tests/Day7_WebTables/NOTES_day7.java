...
When you create a locator that returns more than one option, you have the freedom to pass index number to select which one you want to get.
    ...
    if they are not siblings: you must surround the whole locator with parentheses (), then pass index number.
        (//div[@class='something'])[2]
        (//div[@class='something'])[3]
        (//div[@class='something'])[4]
...
PIQ - How you handle web table?
-depends, but I will look for specific table web element by creating custom xpath locator

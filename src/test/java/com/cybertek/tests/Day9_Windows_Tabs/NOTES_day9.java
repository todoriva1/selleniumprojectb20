...
ALERTS
    ...
    #2 - Javascript Alerts:
        ...
        - Javascript alerts are not created in the HTML code. That's why, we cannot locate and handle them as any other web element. We have to use special class that was created for alerts.
